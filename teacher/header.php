...
<body style="background-color: black;">
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5 py-lg-0">
        <a href="#" class="navbar-brand d-flex align-items-center">
            <h2 class="m-0"><i class="fa fa-building text-primary me-3"></i>PERFECT LEARNING SYSTEM</h2>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-3 py-lg-0">
                ...
                <a href="students.php" class="nav-item nav-link">Student List</a>
                <!-- <a href="/students" class="nav-item nav-link">Students</a> -->

                <a href="note_upload.php" class="nav-item nav-link">Upload Note</a>
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-light m-0">
                        ...
                        <a href="student_assignment.php" class="dropdown-item">View Assignment</a>
                    </div>
                </div>
                
                <a href="student_doubt.php" class="nav-item nav-link">Student Doubt</a>
